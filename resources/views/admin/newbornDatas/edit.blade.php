    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.newborn-datas.update", [$newbornData->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('thermal') ? 'is-invalid' : '' }}" type="number" name="thermal" id="thermal" value="{{ old('thermal', $newbornData->thermal) }}" step="0.000001" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('notes') ? 'is-invalid' : '' }}" name="notes" id="notes">{!! old('notes', $newbornData->notes) !!}</textarea>
                @if($errors->has('notes'))
                    <div class="invalid-feedback">
                        {{ $errors->first('notes') }}
                    </div>
